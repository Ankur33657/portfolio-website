...
export const portfolioData = {
  personal: {
    ...
    resumeUrl:
      "https://drive.google.com/file/d/1dFTWqS0Mxpz2DzpMTyGUU1uTT62qCXPa/view?usp=sharing",
  ...
  projects: [
    {
      title: "Dev Insta",
      description:
        "Backend-focused platform with Node.js APIs and real-time features using Socket.io.",
    ...
    },
    {
      ...
      description:
        "Backend ride-matching system using Dijkstra algorithm for route optimization.",
      technologies: [
        "Node.js",
        "MongoDB",
        "Dijkstra Algorithm",
    ...
    },
    {
      ...
      description:
        "Sentiment analysis tool that evaluates reviews and generates ratings.",
    ...
    },
    {
      ...
      description:
        "CRUD-based notes application with real-time chat using Socket.io.",
    ...
    },
    {
      title: "Sudoku Solver",
      description:
        "Sudoku solving application using backtracking algorithm to efficiently compute valid solutions.",
  ...
  codingProfiles: [
    ...
    },
    {
      ...
      badges: [
        "Global Rank:27(April long one)",
        "Global Rank:27(April long two)",
        "Highest Rating 1581",
      ],
    },
  ],
  certifications: [
    {
      ...
      year: "Issued Apr 2024",
      link: "https://drive.google.com/file/d/13ggeE4rG1b6ESiGBKyppl-ndYtdd0qIe/view",
    },
    {
      name: "Probability and statistics",
      issuer: "NPTEL",
      year: "Issued Apr 2023",
      link: "https://drive.google.com/file/d/1e5ia7zow8-AIX7FVrH-8N6e3rFYXUtt4/view",
    },
    {
      name: "Discrete Mathematics",
      issuer: "NPTEL",
      year: "Issued Oct 2022",
      link: "https://drive.google.com/file/d/1n3MtUOnHcUsvGJameGwdqTpTd9yhhClo/view",
    },
    {
      name: "Full stack web development",
      issuer: "Udemy",
      year: "Issued Feb 2024",
      link: "https://www.linkedin.com/in/ankur-singh-8b470b206/details/certifications/1708812441790/single-media-viewer/?profileId=ACoAADRuQ0gBI9hkKEErW-sT620goPlV5sJs3mM",
    },
  ],
  activities: [
    {
      title: "Winner – Chase the Code 3.0",
      description: "Winner of coding contest organized by CSI CU.",
    },
    {
      title: "SIH Finalist",
      description: "Finalist for Smart India Hackathon via Teckathon 2.0.",
    },
    {
      title: "HackHound 2.0",
      description:
        "Secured 5th place in hackathon organized by SRM University Delhi.",
    },
    {
      title: "Lensathon & Code Genius",
      description: "Participated in IEEE CUSB technical competitions.",
    },
    {
      title: "CodeChef Global Rank",
      description: "Achieved global ranks 27 and 24 in CodeChef contests.",
    },
  ],
};
